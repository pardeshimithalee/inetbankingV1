...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		extent.setSystemInfo("user", "mithalee");
	...
	public void onTestFailure(ITestResult tr) {
		...
		logger.log(Status.FAIL, MarkupHelper.createLabel(tr.getName(), ExtentColor.RED)); // send the passed information
																							...
																							// color highlighted
		// If the test case fails we want a screenshot to be taken.
		// So we write a line here for that but again the screenshot method should be
		// implemented in the base class as well. So we add that method in Base class
		//
